...
# source https://github.com/tchabaud/dockerfiles/blob/afe0fc68d12eb3d89693320b18a9d7018ef3bc31/amule/amule.sh
...
AMULE_UID=${PUID:-5000}
AMULE_GID=${PGID:-5000}
AMULE_WEBUI_TEMPLATE=${WEBUI_TEMPLATE:-AmuleWebUI-Reloaded}

AMULE_HOME=/home/amule/.aMule
AMULE_ARGS=${AMULE_ARGS:-"-c ${AMULE_HOME} -o"}
...
if grep -q ":${AMULE_UID}:" /etc/passwd; then
    ...
    adduser -S -s /bin/bash -u "${AMULE_UID}" -h "/home/amule" -G "${AMULE_GROUP}" amule
fi
